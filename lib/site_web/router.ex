defmodule SiteWeb.Router do
  ...
  if Application.compile_env(:site, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: SiteWeb.Telemetry, ecto_sqlite3_extras_options: []
  ...
  scope "/", SiteWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{SiteWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", SiteWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{SiteWeb.UserAuth, :ensure_authenticated}] do
      live "/users/settings", UserSettingsLive, :edit
      live "/users/settings/confirm_email/:token", UserSettingsLive, :confirm_email
      live "/users/bookmarks", BookmarksLive, :edit
    end
  end
